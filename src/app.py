...
activities = {
    ...
    "Drama Club": {
        "description": "Perform scenes, build confidence, and explore theater",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": []
    },
    "Photography Club": {
        "description": "Learn camera techniques and create visual projects",
    ...
    "Debate Club": {
        "description": "Practice argumentation, research, and public speaking",
